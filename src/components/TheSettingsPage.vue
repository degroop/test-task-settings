...
<script lang="ts">
    ...
    import TheSettingsPageWorkingHours from '@/components/TheSettingsPageWorkingHours.vue';
    ...
    @Component({
        components: {
            EmptyTab,
            TheSettingsPageWorkingHours
        },
        computed: mapState([
            'currentPage'
        ])
    })
    export default class TheSettingsPage extends Vue {
        private currentTab: string = 'Working hours'
        private tabs: Array<TabComponentInterface> = [
            { title: 'Profile', component: 'EmptyTab'},
            { title: 'Notifications', component: 'EmptyTab'},
            { title: 'Password', component: 'EmptyTab'},
            { title: 'Working hours', component: 'TheSettingsPageWorkingHours'},
